// Package herdr provides SSH tunnel support for remote herdr connections.
//
// Usage:
//
//	tun := herdr.NewTunnel("fofo@192.168.2.60", "/home/fofo/.config/herdr/herdr.sock", 19999)
//	if err := tun.Start(); err != nil { ... }
//	defer tun.Close()
//	if err := tun.WaitReady(10 * time.Second); err != nil { ... }
//	// Use herdr.New("127.0.0.1:19999") to connect to the remote herdr via TCP
package herdr
